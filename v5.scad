...
pcbWidth          = 55;   // side to side (Y axis)
pcbThickness      = 1.6;
standoffHeight    = 14.0; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
...
showOrientation           = false;       //-> Show the Front/Back/Left/Right labels : only in preview
...
connectors   =
[
  [ 5.00, 5.00, -1.6, 3, 5, 3, 7, yappAllCorners, yappSelfThreading, yappNoFillet], 
];
...
cutoutsLeft = 
[
    [17.5, 1.2, 15, 2, 0.5, yappRoundedRect, yappCenter, yappCoordPCB], // SD1
    [71.5, -5.0, 10, 3, 0.5, yappRoundedRect, yappCenter, yappCoordPCB], // power switch    
...
lightTubes =
[
    [80, 1.7, 1, 1, 1, 1, yappCircle, yappNoFillet], // LED1
    [83.2, 1.7, 1, 1, 1, 1, yappCircle, yappNoFillet], // LED2
    [86.4, 1.7, 1, 1, 1, 1, yappCircle, yappNoFillet], // LED3
    [89.6, 1.7, 1, 1, 1, 1, yappCircle, yappNoFillet], // LED4     
];
...
ridgeExtLeft = 
[
    [70.000, 8.000, 13.60, yappCoordBox] // switch
];
...
ridgeExtFront = 
[
    [13.8, 9.4, 14.2, yappCoordBox, yappCoordBoxInside], // type-c
    [39, 5.6, 13.60, yappCoordBox, yappCoordBoxInside], // 3.5mm
];
...
displayMounts =
[
    [44,30, 62,44, 0,0,0,0,0,0, 49,37, -3.5,0, 0,0,0, 1.5, yappCenter  ], 
];
